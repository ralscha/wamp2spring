...
/**
 * Strategy for a concrete WAMP authentication method during session establishment.
 */
public interface WampAuthenticationProvider {

	String getAuthMethod();

	WampAuthenticationChallenge challenge(HelloMessage helloMessage);

	WampAuthentication authenticate(HelloMessage helloMessage, AuthenticateMessage authenticateMessage,

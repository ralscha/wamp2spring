...
import ch.rasc.wampspring.event.WampProcedureRegisteredEvent;
import ch.rasc.wampspring.event.WampProcedureUnregisteredEvent;
...
import ch.rasc.wampspring.message.RegisteredMessage;
import ch.rasc.wampspring.message.ResultMessage;
import ch.rasc.wampspring.message.UnregisterMessage;
import ch.rasc.wampspring.message.UnregisteredMessage;
